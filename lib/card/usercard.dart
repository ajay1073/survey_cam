                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Device: ${model.deviceID.toString()}",
                        style: TextStyle(
                            fontFamily: "Montserrat",
                            fontSize: screenSize.height * 0.025,
                            fontWeight: FontWeight.w500),
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Sign-Up Date: ${model.signUp.toDate().day.toString().padLeft(2, '0')}/${model.signUp.toDate().month.toString().padLeft(2, '0')}/${model.signUp.toDate().year.toString()} ${model.signUp.toDate().hour.toString().padLeft(2, '0')}:${model.signUp.toDate().minute.toString().padLeft(2, '0')}:${model.signUp.toDate().second.toString().padLeft(2, '0')}",
                        style: TextStyle(
                            fontFamily: "Montserrat",
                            fontSize: screenSize.height * 0.025,
                            fontWeight: FontWeight.w500),
